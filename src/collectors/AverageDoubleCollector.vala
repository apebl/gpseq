...
private class Gpseq.Collectors.AverageDoubleCollector<G> : Object, Collector<double?,Accumulator,G> {
	private MapFunc<double?,G> _mapper;

	public AverageDoubleCollector (owned MapFunc<double?,G> mapper) {
	...
	public class Accumulator : Object {
		...
		public Accumulator (double val, int64 count) {
			_val = val;
			_count = count;
		}
	}
